...
import com.example.android.bluetoothlegatt.BLEGattManager.operations.GattCharacteristicReadOperation;
import com.example.android.bluetoothlegatt.BLEGattManager.operations.GattDescriptorReadOperation;
import com.example.android.bluetoothlegatt.BLEGattManager.operations.GattOperation;
import com.example.android.bluetoothlegatt.BLEGattManager.CharacteristicChangeListener;
        ...
        if(mGatts.containsKey(device.getAddress())) {
            ...
            device.connectGatt(Injector.getApplicationContext(), true, new BluetoothGattCallback() {
                ...
                public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
                    ...
                    L.d("Characteristic " + characteristic.getUuid() + " written to on device " + device.getAddress() + " Status: " + status);
                    setCurrentOperation(null);
                    drive();
                }
